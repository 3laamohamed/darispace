...
class ThemeOptionSeeder extends BaseSeeder
{
    public function run(): void
    {
        ...
        $data = [
            'en_US' => [
                'site_name' => 'Hously',
                'site_title' => 'Find your favorite homes at Hously',
                ...
                'copyright' => '© ' . now()->format('Y') . ' Archi Elite JSC. All right reserved.',
                'favicon' => 'general/favicon.png',
                'logo' => 'general/logo-dark.png',
                'logo_light' => 'general/logo-light.png',
                'logo_dark' => 'general/logo-dark.png',
                'primary_font' => 'League Spartan',
                'primary_color' => '#16a34a',
                'secondary_color' => '#15803D',
                'homepage_id' => Page::value('id'),
        ...
        foreach ($data as $locale => $settings) {
            foreach ($settings as $key => $value) {
                ...
                Setting::insertOrIgnore($settingItem);
            }
        }
    }
}
