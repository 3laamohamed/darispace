<div class="lg:col-span-3 md:col-span-4">
    ...
    @if($address = Arr::get($config, 'address'))
        <div class="flex mt-6">
            <i data-feather="map-pin" class="w-5 h-5 text-primary ltr:mr-3 rtl:ml-3"></i>
            <div>
    ...
    @if($email = Arr::get($config, 'email'))
        <div class="flex mt-6">
            <i data-feather="mail" class="w-5 h-5 text-primary ltr:mr-3 rtl:ml-3"></i>
            <div>
    ...
    @if($phone = Arr::get($config, 'phone'))
        <div class="flex mt-6">
            <i data-feather="phone" class="w-5 h-5 text-primary ltr:mr-3 rtl:ml-3"></i>
            <div>
