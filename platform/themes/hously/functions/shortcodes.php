...
app()->booted(function () {
    ...
    if (is_plugin_active('real-estate')) {
        ...
        add_shortcode('featured-investors', __('Featured Investors'), __('Featured Investors'), function (Shortcode $shortcode) {
            ...
            $investors = Investor::take((int)$shortcode->limit ?: 6)->get();

            return Theme::partial('shortcodes.featured-investors.index', compact('shortcode', 'investors'));
        });
        ...
        add_shortcode('investors-list', __('Investors List'), __('Investors List'), function (Shortcode $shortcode) {
            Theme::asset()->container('footer')->usePath()->add('filter', 'js/filter.js');
            Theme::asset()->container('footer')->usePath()->add('wishlist', 'js/wishlist.js');
            ...
            return Theme::partial('shortcodes.investors-list.index', compact('shortcode', 'investors', 'showMap'));
        });

        shortcode()->setAdminConfig('investors-list', function (array $attributes) {
            return Theme::partial('shortcodes.investors-list.admin', compact('attributes'));
        });
