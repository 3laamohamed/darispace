                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <div class="flex justify-between mb-4">
                            <div class="flex items-center mb-0 form-checkbox">
                                <input class="ltr:mr-2 rtl:ml-2 border border-inherit w-[16px] h-[16px] mb-[3px]" type="checkbox" name="remember" value="{{ old('remember') ? 'checked' : '' }}" id="RememberMe">
                        ...
                        <div class="text-center">
                            <span class="text-slate-400 ltr:mr-2 rtl:ml-2">{{ __('Don\'t have an account?') }}</span> <a href="{{ route('public.account.register') }}" class="font-bold text-black dark:text-white">{{ __('Register') }}</a>
                        </div>
                    </div>
                </form>
