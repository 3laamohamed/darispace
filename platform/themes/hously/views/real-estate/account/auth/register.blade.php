    ...
    <div class="container z-3">
        <div class="flex justify-center mt-10">
            <div class="login-form max-w-[500px] w-full m-auto p-6 bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-700 rounded-md">
                ...
                <form class="ltr:text-left rtl:text-right" action="{{ route('public.account.register') }}" method="post">
                    @csrf
                    <div class="grid grid-cols-1">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div class="mb-4">
                                ...
                                <input id="email" name="email" type="email" @class(['form-control form-input dark:bg-slate-800 mt-1', 'is-invalid' => $errors->has('email')]) placeholder="{{ 'name@gmail.com' }}">
                                @error('email')
                                <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="text-center">
                            <span class="text-slate-400 ltr:mr-2 rtl:ml-2">{{ __('Already have an account?') }}</span> <a href="{{ route('public.account.login') }}" class="font-bold text-black dark:text-white">{{ __('Login') }}</a>
                        </div>
                    </div>
                </form>
