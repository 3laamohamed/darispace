...
<body class="dark:bg-slate-900">
                ...
                <div class="flex flex-col justify-center min-h-screen px-4 py-10 md:px-10">
                    <div class="text-center">
                        <a href="{{ route('public.index') }}">
                            <img src="{{ asset('themes/hously/images/logo-icon-64.png') }}" class="mx-auto" alt="{{ theme_option('site_name') }}">
                        </a>
                    </div>
                    <div class="my-auto text-center title-heading">
                        <img src="{{ asset('themes/hously/images/error.png') }}" class="mx-auto" alt="{{ theme_option('site_name') }}">
    ...
    <div class="fixed z-10 bottom-3 ltr:right-3 rtl:left-3">
