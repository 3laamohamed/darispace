                    ...
                    <div class="p-6">
                        <ul class="p-0 m-0 list-none">
                            @if ($package->number_of_listings)
                                <li class="mt-2 text-slate-400"><span class="text-lg text-primary ltr:mr-2 rtl:ml-2"><i class="align-middle mdi mdi-check-circle"></i></span>{{ __(':number Listings', ['number' => $package->number_of_listings]) }}</li>
                            @endif
                            @if ($package->account_limit === 1)
                                <li class="mt-2 text-slate-400"><span class="text-lg text-primary ltr:mr-2 rtl:ml-2"><i class="align-middle mdi mdi-check-circle"></i></span>{{ __('Limited purchase by account') }}</li>
                            @elseif (! $package->account_limit)
                                <li class="mt-2 text-slate-400"><span class="text-lg text-primary ltr:mr-2 rtl:ml-2"><i class="align-middle mdi mdi-check-circle"></i></span>{{ __('Unlimited purchase by account') }}</li>
                            @endif
                        </ul>
