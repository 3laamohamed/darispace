    ...
    <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
            ...
            <div class="relative">
                ...
                <div class="absolute left-0 right-0 text-center bottom-2/4 translate-y-2/4">
                    <a href="#!" data-type="youtube" data-id="yba7hPeTSjk"
                       class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-full shadow-md lightbox dark:shadow-gyay-700 dark:bg-slate-900 text-primary">
        ...
        <div class="md:col-span-7">
            <div class="ltr:lg:ml-4 rtl:lg:mr-4">
                ...
                <div class="mt-4">
                    <a href="" class="mt-3 text-white rounded-md btn bg-primary hover:bg-secondary">Learn More </a>
                </div>
            </div>
        </div>
    </div>
