        ...
        @foreach(range(1, 6) as $i)
            <div class="relative overflow-hidden text-center transition-all duration-500 ease-in-out bg-white group md:text-left lg:px-10 rounded-xl dark:bg-slate-900">
                <div class="relative -m-3 overflow-hidden text-transparent">
                    ...
                    <div class="absolute top-[50%] md:left-[45px] rtl:right-[45px] left-1/2 -translate-x-[50%] -translate-y-[50%] text-primary rounded-xl transition-all duration-500 ease-in-out text-4xl flex align-middle justify-center items-center">
