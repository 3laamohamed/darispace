...
<html lang="{{ app()->getLocale() }}" class="light scroll-smooth" dir="{{ BaseHelper::siteLanguageDirection() === 'rtl' ? 'rtl' : 'ltr' }}">
    ...
    j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
    'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
    })(window,document,'script','dataLayer','GTM-KC68D9H3');</script>
    <!-- End Google Tag Manager -->
  ...
  .kmacb__manager-circle {
    ...
    <body class="dark:bg-slate-900">
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K6FMSWK"
            ...
            <!-- Google Tag Manager (noscript) -->
            <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KC68D9H3"
            height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
            <!-- End Google Tag Manager (noscript) -->

            <!-- wpp-btn-mobile -->
            <div class="phone-call cbh-phone cbh-green cbh-show  cbh-static" id="clbh_phone_div" style=""><a id="WhatsApp-button" href="https://wa.me/+201122465273" target="_blank" class="phoneJs" title="WhatsApp 360imagem"><div class="cbh-ph-circle"></div><div class="cbh-ph-circle-fill"></div><div class="cbh-ph-img-circle1"></div></a></div>
            <!-- wpp-btn-mobile -->
