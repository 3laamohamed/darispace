<div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
    ...
    <div class="w-full mx-auto overflow-hidden duration-500 ease-in-out bg-white shadow project-item group rounded-xl dark:bg-slate-900 hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-700 dark:hover:shadow-gray-700 lg:max-w-2xl">
